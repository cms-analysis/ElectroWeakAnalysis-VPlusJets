...
##########################################################################
 ...
 do
   eldijet=datacard_wwgamaqgc_el_KCW:${KCW}.txt
   mudijet=datacard_wwgamaqgc_mu_KCW:${KCW}.txt
   echo "combineCards.py mudijet=${mudijet} eldijet=${eldijet} >datacard_wwgamaqgc_2chan_KCW:${KCW}.txt"
   combineCards.py mudijet=${mudijet} eldijet=${eldijet} >datacard_wwgamaqgc_2chan_KCW:${KCW}.txt
 done
