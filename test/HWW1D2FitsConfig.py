...
mu2Pars = {
    ...
    200: ( "mva2j200mu", 0.600, 165.0, 245.0, 10,
           {'diboson': (13, 11), 'top': (13, 8), 'WpJ': (15, 14), 
            'ggH': (13, 5), 'qqH': (13, 5)} ),
    250: ( "mva2j250mu", 0.650, 200.0, 400.0, 10,
           {'diboson': (13, 11), 'top': (13, 10), 'WpJ': (10, 14), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    300: ( "mva2j300mu", 0.600, 240.0, 400.0, 8,
           {'diboson': (13, 11), 'top': (5, 10), 'WpJ': (10, 12), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    350: ( "mva2j350mu", 0.600, 250., 475., 9,
           {'diboson': (7, 11),'top':(5, 11),'WpJ':(10, 12),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    400: ( "mva2j400mu", 0.550, 300.0, 600, 10,
           {'diboson':(7, 11),'top':(5, 10),'WpJ':(10, 12),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    450: ( "mva2j450mu", 0.600, 340.0, 740.0, 10,
           {'diboson':(7, 12),'top':(5, 12),'WpJ':(10, 18),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    500: ( "mva2j500mu", 0.500, 340.0, 780.0, 11,
           {'diboson': (7, 12), 'top': (5, 12), 'WpJ': (10, 18),
            'ggH': (13, 5),'qqH': (7, 5)} ),
    550: ( "mva2j550mu", 0.550, 340.0, 780.0, 11,
           {'diboson': (7, 12), 'top': (5, 12), 'WpJ': (10, 18),
            'ggH': (13, 5),'qqH': (7, 5)} ),
    600: ( "mva2j600mu", 0.650, 340.0, 780.0, 11,
           {'diboson': (7, 12), 'top': (5, 12), 'WpJ': (10, 18),
            'ggH': (13, 5),'qqH': (7, 5)} ),
    }

el2Pars = {
    170: ( "mva2j170el", 0.300, 165.0, 245.0, 10,
           {'diboson':(13, 8),'top':(13, 8),'WpJ':(15, 10),
            'ggH':(13, 5),'qqH':(13, 5)} ),
    180: ( "mva2j180el", 0.550, 165.0, 245.0, 10,
           {'diboson': (13, 11),'top':(13, 8),'WpJ':(10, 14),
            'ggH':(13, 5),'qqH':(13, 5)} ),
    190: ( "mva2j190el", 0.550, 165.0, 245.0, 10,
           {'diboson': (13, 11), 'top': (13, 8), 'WpJ': (10, 10), 
            'ggH': (13, 5), 'qqH': (13, 5)} ),
    200: ( "mva2j200el", 0.600, 165.0, 245.0, 10 ,
           {'diboson': (13, 11), 'top': (13, 8), 'WpJ': (10, 10), 
            'ggH': (13, 5), 'qqH': (7, 5)}),
    250: ( "mva2j250el", 0.650, 240.0, 400.0, 16,
           {'diboson': (13, 11), 'top': (5, 10), 'WpJ': (10, 12), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    ...
    350: ( "mva2j350el", 0.600, 250., 475., 15,
           {'diboson': (7, 11),'top':(13, 11),'WpJ':(10, 12),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    400: ( "mva2j400el", 0.550, 300.0, 600, 15,
