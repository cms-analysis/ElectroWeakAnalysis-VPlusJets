...
el2Pars = {
    ...
    200: ( "mva2j200el", 0.750, 165.0, 245.0, 10 ,
           {'diboson': (22, 11), 'top': (13, 8), 'WpJ': (10, 14), 
            'ggH': (13, 5), 'qqH': (13, 5)}),
    250: ( "mva2j250el", 0.800, 200.0, 400.0, 10,
           {'diboson': (22, 11), 'top': (13, 10), 'WpJ': (10, 10), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    300: ( "mva2j300el", 0.800, 240.0, 400.0, 8,
           {'diboson': (22, 11), 'top': (5, 12), 'WpJ': (10, 12), 
            'ggH': (13, 5), 'qqH': (7, 5)} ),
    350: ( "mva2j350el", 0.800, 250., 475., 9,
           {'diboson': (22, 11),'top':(5, 11),'WpJ':(10, 12),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    400: ( "mva2j400el", 0.800, 300.0, 600, 10,
           {'diboson':(31, 11),'top':(13, 12),'WpJ':(10, 12),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    450: ( "mva2j450el", 0.800, 340.0, 780.0, 10,
           {'diboson':(31, 12),'top':(5, 12),'WpJ':(10, 18),
            'ggH':(13, 5),'qqH':(7, 5)} ),
    500: ( "mva2j500el", 0.750, 340.0, 780.0, 11,
           {'diboson': (22, 12), 'top': (5, 12), 'WpJ': (10, 18),
            'ggH': (13, 5),'qqH': (7, 5)} ),
    550: ( "mva2j550el", 0.750, 340.0, 780.0, 11,
           {'diboson': (22, 12), 'top': (5, 12), 'WpJ': (10, 18),
            'ggH': (13, 5),'qqH': (7, 5)} ),
    600: ( "mva2j600el", 0.750, 340.0, 780.0, 11,
           {'diboson': (22, 12), 'top': (5, 12), 'WpJ': (10, 18),
            'ggH': (13, 5),'qqH': (7, 5)} ),
    }
...
def theConfig(Nj, mH, isElectron = False, initFile = [], includeSignal = True):
    ...
    pars.varRanges = {'Mass2j_PFCor': (12, 50., 146., []),
                      'fit_mlvjj': (modePars[mH][4]*10, modePars[mH][2], 
                                    modePars[mH][3], [])
                      }
    pars.plotRanges = {'Mass2j_PFCor': (12, 50., 146., []),
