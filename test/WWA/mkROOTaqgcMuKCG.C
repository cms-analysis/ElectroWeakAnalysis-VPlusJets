...
// WA+jets norm - data driven : 1.108 +- 0.065
  ...
  const double KCG_p8m5_scale     = 1.5 * 0.043602 * intLUMI/172326 ;
  const double KCG_p5m5_scale     = 1.5 * 0.029437 * intLUMI/115605;
  const double KCG_p3m5_scale     = 1.5 * 0.0236905 * intLUMI/199484;
  const double KCG_m3m5_scale     = 1.5 * 0.024164 * intLUMI/193989;
  const double KCG_m5m5_scale     = 1.5 * 0.030337 * intLUMI/94299;
  const double KCG_m8m5_scale     = 1.5 * 0.045029 * intLUMI/197270;
...
// ! no need for extra PUwt stat err. sumw2 is enough
  ...
  TFile f("mu_aCW_WWA_PhotonEt_MVA01.root", "RECREATE");
  ...
  KCG_m8m5_file = new TFile("InData/RD_mu_KCG_m8m5MG_CMSSW532.root");
  KCG_m5m5_file = new TFile("InData/RD_mu_KCG_m5m5MG_CMSSW532.root");
  KCG_m3m5_file = new TFile("InData/RD_mu_KCG_m3m5MG_CMSSW532.root");
  KCG_p3m5_file = new TFile("InData/RD_mu_KCG_p3m5MG_CMSSW532.root");
  KCG_p5m5_file = new TFile("InData/RD_mu_KCG_p5m5MG_CMSSW532.root");
  KCG_p8m5_file = new TFile("InData/RD_mu_KCG_p8m5MG_CMSSW532.root");
  ...
  TH1* signal_aCw_8 = new TH1D("signal_aCw_8","signal_aCw_8",pv.NBINS, pv.MINRange, pv.MAXRange);
  TH1* signal_aCw_5 = new TH1D("signal_aCw_5","signal_aCw_5",pv.NBINS, pv.MINRange, pv.MAXRange);
  TH1* signal_aCw_3 = new TH1D("signal_aCw_3","signal_aCw_3",pv.NBINS, pv.MINRange, pv.MAXRange);
  TH1* signal_aCw_m3 = new TH1D("signal_aCw_m3","signal_aCw_-2",pv.NBINS, pv.MINRange, pv.MAXRange);
  TH1* signal_aCw_m5 = new TH1D("signal_aCw_m5","signal_aCw_-3",pv.NBINS, pv.MINRange, pv.MAXRange);
  TH1* signal_aCw_m8 = new TH1D("signal_aCw_m8","signal_aCw_-5",pv.NBINS, pv.MINRange, pv.MAXRange);
  ...
  treeKCG_p8m5->Draw(TString(pv.plotvar)+TString(">>signal_aCw_m8"), the_cut, "goff");

  std::cout<<"Fill aQGC_2 WWA Histogram..."<<std::endl;
  treeKCG_p5m5->Draw(TString(pv.plotvar)+TString(">>signal_aCw_m5"), the_cut, "goff");

  std::cout<<"Fill aQGC_3 WWA Histogram..."<<std::endl;
  treeKCG_p3m5->Draw(TString(pv.plotvar)+TString(">>signal_aCw_m3"), the_cut, "goff");

  std::cout<<"Fill aQGC_4 WWA Histogram..."<<std::endl;
  treeKCG_m3m5->Draw(TString(pv.plotvar)+TString(">>signal_aCw_3"), the_cut, "goff");

  std::cout<<"Fill aQGC_5 WWA Histogram..."<<std::endl;
  treeKCG_m5m5->Draw(TString(pv.plotvar)+TString(">>signal_aCw_5"), the_cut, "goff");

  std::cout<<"Fill aQGC_6 WWA Histogram..."<<std::endl;
  treeKCG_m8m5->Draw(TString(pv.plotvar)+TString(">>signal_aCw_8"), the_cut, "goff");

  signal_aCw_8->AddBinContent(pv.NBINS,signal_aCw_8->GetBinContent(pv.NBINS+1));signal_aCw_8->SetBinContent(pv.NBINS+1,0.);
  signal_aCw_5->AddBinContent(pv.NBINS,signal_aCw_5->GetBinContent(pv.NBINS+1));signal_aCw_5->SetBinContent(pv.NBINS+1,0.);
  signal_aCw_3->AddBinContent(pv.NBINS,signal_aCw_3->GetBinContent(pv.NBINS+1));signal_aCw_3->SetBinContent(pv.NBINS+1,0.);
  signal_aCw_m3->AddBinContent(pv.NBINS,signal_aCw_m3->GetBinContent(pv.NBINS+1));signal_aCw_m3->SetBinContent(pv.NBINS+1,0.);
  signal_aCw_m5->AddBinContent(pv.NBINS,signal_aCw_m5->GetBinContent(pv.NBINS+1));signal_aCw_m5->SetBinContent(pv.NBINS+1,0.);
  signal_aCw_m8->AddBinContent(pv.NBINS,signal_aCw_m8->GetBinContent(pv.NBINS+1));signal_aCw_m8->SetBinContent(pv.NBINS+1,0.);
...
//  Adding Normalization uncertainty to WA+jets
  ...
  signal_aCw_m8->Scale(KCG_m8m5_scale);
  signal_aCw_m5->Scale(KCG_m5m5_scale);
  signal_aCw_m3->Scale(KCG_m3m5_scale);
  signal_aCw_3->Scale(KCG_p3m5_scale);
  signal_aCw_5->Scale(KCG_p5m5_scale);
  signal_aCw_8->Scale(KCG_p8m5_scale);
  ...
  signal_aCw_8->Add(th1wwa,-1);
  signal_aCw_5->Add(th1wwa,-1);
  signal_aCw_3->Add(th1wwa,-1);
  signal_aCw_m3->Add(th1wwa,-1);
  signal_aCw_m5->Add(th1wwa,-1);
  signal_aCw_m8->Add(th1wwa,-1);
...
//  Double_t change;
  ...
  signal_aCw_8->SetYTitle(tmpc);
  signal_aCw_8->GetXaxis()->SetTitle(pv.xlabel);
  signal_aCw_8->GetYaxis()->CenterTitle(true);

  signal_aCw_5->SetYTitle(tmpc);
  signal_aCw_5->GetXaxis()->SetTitle(pv.xlabel);
  signal_aCw_5->GetYaxis()->CenterTitle(true);

  signal_aCw_3->SetYTitle(tmpc);
  signal_aCw_3->GetXaxis()->SetTitle(pv.xlabel);
  signal_aCw_3->GetYaxis()->CenterTitle(true);

  signal_aCw_m3->SetYTitle(tmpc);
  signal_aCw_m3->GetXaxis()->SetTitle(pv.xlabel);
  signal_aCw_m3->GetYaxis()->CenterTitle(true);

  signal_aCw_m5->SetYTitle(tmpc);
  signal_aCw_m5->GetXaxis()->SetTitle(pv.xlabel);
  signal_aCw_m5->GetYaxis()->CenterTitle(true);

  signal_aCw_m8->SetYTitle(tmpc);
  signal_aCw_m8->GetXaxis()->SetTitle(pv.xlabel);
  signal_aCw_m8->GetYaxis()->CenterTitle(true);
