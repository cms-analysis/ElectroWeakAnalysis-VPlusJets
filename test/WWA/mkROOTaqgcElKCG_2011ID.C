...
// WA+jets norm - data driven : 1.045 +- 0.086
 ...
 // ! no need for extra PUwt stat err. sumw2 is enough
  ...
  TFile f("el_aCW_WWA_PhotonEt_MVA01.root", "RECREATE");
  ...
  KCG_m8m5_file = new TFile("InData/RD_el_KCG_m8m5MG_CMSSW532.root");
  KCG_m5m5_file = new TFile("InData/RD_el_KCG_m5m5MG_CMSSW532.root");
  KCG_m3m5_file = new TFile("InData/RD_el_KCG_m3m5MG_CMSSW532.root");
  KCG_p3m5_file = new TFile("InData/RD_el_KCG_p3m5MG_CMSSW532.root");
  KCG_p5m5_file = new TFile("InData/RD_el_KCG_p5m5MG_CMSSW532.root");
  KCG_p8m5_file = new TFile("InData/RD_el_KCG_p8m5MG_CMSSW532.root");
