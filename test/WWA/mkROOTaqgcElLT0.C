...
// WA+jets norm - data driven : 1.045 +- 0.086
 ...
 // ! no need for extra PUwt stat err. sumw2 is enough
  ...
  TFile f("el_LT0_WWA_PhotonEt_MVA01.root", "RECREATE");
  ...
  LT0_m8m5_file = new TFile("InData/RD_el_LT0_m8m11MG_CMSSW532.root");
  LT0_m5m5_file = new TFile("InData/RD_el_LT0_m5m11MG_CMSSW532.root");
  LT0_m3m5_file = new TFile("InData/RD_el_LT0_m3m11MG_CMSSW532.root");
  LT0_p3m5_file = new TFile("InData/RD_el_LT0_p3m11MG_CMSSW532.root");
  LT0_p5m5_file = new TFile("InData/RD_el_LT0_p5m11MG_CMSSW532.root");
  LT0_p8m5_file = new TFile("InData/RD_el_LT0_p8m11MG_CMSSW532.root");
