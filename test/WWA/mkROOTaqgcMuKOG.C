...
// ! no need for extra PUwt stat err. sumw2 is enough
  ...
  TFile f("mu_a0W_WWA_PhotonEt_MVA01.root", "RECREATE");
  ...
  KOG_m5m5_file = new TFile("InData/RD_mu_KOG_m5m5MG_CMSSW532.root");
  KOG_m3m5_file = new TFile("InData/RD_mu_KOG_m3m5MG_CMSSW532.root");
  KOG_m2m5_file = new TFile("InData/RD_mu_KOG_m2m5MG_CMSSW532.root");
  KOG_p2m5_file = new TFile("InData/RD_mu_KOG_p2m5MG_CMSSW532.root");
  KOG_p3m5_file = new TFile("InData/RD_mu_KOG_p3m5MG_CMSSW532.root");
  KOG_p5m5_file = new TFile("InData/RD_mu_KOG_p5m5MG_CMSSW532.root");
