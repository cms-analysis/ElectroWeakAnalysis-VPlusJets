...
//mva2jWWAmuA1>0.32
  ...
  TFile f("para_mu_aCW_WWA_PhotonEt.root", "RECREATE");
  ...
  KCG_m8m5_file = new TFile("InData_New/RD_mu_KCG_m8m5MG_CMSSW532.root");
  KCG_m5m5_file = new TFile("InData_New/RD_mu_KCG_m5m5MG_CMSSW532.root");
  KCG_m3m5_file = new TFile("InData_New/RD_mu_KCG_m3m5MG_CMSSW532.root");
  KCG_p3m5_file = new TFile("InData_New/RD_mu_KCG_p3m5MG_CMSSW532.root");
  KCG_p5m5_file = new TFile("InData_New/RD_mu_KCG_p5m5MG_CMSSW532.root");
  KCG_p8m5_file = new TFile("InData_New/RD_mu_KCG_p8m5MG_CMSSW532.root");
