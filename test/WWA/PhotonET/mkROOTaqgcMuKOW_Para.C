...
//mva2jWWAmuA1>0.32
  ...
  TFile f("para_mu_K0W_WWA_PhotonEt.root", "RECREATE");
  ...
  KOW_m2m5_file = new TFile("InData_New/RD_mu_K0W_m2m5MG_CMSSW532.root");
  KOW_m1m5_file = new TFile("InData_New/RD_mu_K0W_m1m5MG_CMSSW532.root");
  KOW_m05m5_file = new TFile("InData_New/RD_mu_K0W_m05m5MG_CMSSW532.root");
  KOW_p05m5_file = new TFile("InData_New/RD_mu_K0W_p05m5MG_CMSSW532.root");
  KOW_p2m5_file = new TFile("InData_New/RD_mu_K0W_p2m5MG_CMSSW532.root");
  KOW_p1m5_file = new TFile("InData_New/RD_mu_K0W_p1m5MG_CMSSW532.root");
