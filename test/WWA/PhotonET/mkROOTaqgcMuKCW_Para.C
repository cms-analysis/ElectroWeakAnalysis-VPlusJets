...
//mva2jWWAmuA1>0.32
  ...
  TFile f("para_mu_KCW_WWA_PhotonEt.root", "RECREATE");
  ...
  KCW_m3m5_file = new TFile("InData_aQGC/RD_mu_kCW_m3m5wwza_CMSSW532.root.root");
  KCW_m2m5_file = new TFile("InData_aQGC/RD_mu_kCW_m2m5wwza_CMSSW532.root.root");
  KCW_m1m5_file = new TFile("InData_aQGC/RD_mu_kCW_m1m5wwza_CMSSW532.root.root");
  KCW_p1m5_file = new TFile("InData_aQGC/RD_mu_kCW_p1m5wwza_CMSSW532.root.root");
  KCW_p3m5_file = new TFile("InData_aQGC/RD_mu_kCW_p3m5wwza_CMSSW532.root.root");
