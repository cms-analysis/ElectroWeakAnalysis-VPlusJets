...
//mva2jWWAmuA1>0.32
  ...
  TFile f("mu_WWA_WZA_Mlvjja.root", "RECREATE");
  ...
  treedata->Draw(TString(pv.plotvar)+TString(">>th1fkdataUp"), fkPhoton_cutUp, "goff");
  th1fkdataUp->AddBinContent(pv.NBINS,th1fkdataUp->GetBinContent(pv.NBINS+1));th1fkdataUp->SetBinContent(pv.NBINS+1,0.);

  treedata->Draw(TString(pv.plotvar)+TString(">>th1fkdataDown"), fkPhoton_cutDown, "goff");
