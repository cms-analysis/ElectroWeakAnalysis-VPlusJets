...
//mva2jWWAelA1>0.2
  ...
  KOG_m140m5_file = new TFile("InData_New/RD_el_a0W_m140m5FF500n2_CMSSW532.root");
  KOG_m100m5_file = new TFile("InData_New/RD_el_a0W_m100m5FF500n2_CMSSW532.root");
  KOG_m80m5_file = new TFile("InData_New/RD_el_a0W_m80m5FF500n2_CMSSW532.root");
  KOG_p80m5_file = new TFile("InData_New/RD_el_a0W_p80m5FF500n2_CMSSW532.root");
  KOG_p100m5_file = new TFile("InData_New/RD_el_a0W_p100m5FF500n2_CMSSW532.root");
  KOG_p140m5_file = new TFile("InData_New/RD_el_a0W_p140m5FF500n2_CMSSW532.root");
...
/*
  signal_a0w_m140->SetBinContent(8,1+p[0][7]*(-140E-5)+p[1][7]*pow(-140E-5,2));
  signal_a0w_m100->SetBinContent(8,1+p[0][7]*(-100E-5)+p[1][7]*pow(-100E-5,2));
  signal_a0w_m80->SetBinContent(8,1+p[0][7]*(-80E-5)+p[1][7]*pow(-80E-5,2));

  signal_a0w_m165->SetBinContent(8,1+p[0][7]*(-165E-5)+p[1][7]*pow(-165E-5,2));
  signal_a0w_m162->SetBinContent(8,1+p[0][7]*(-162E-5)+p[1][7]*pow(-162E-5,2));
  signal_a0w_m159->SetBinContent(8,1+p[0][7]*(-159E-5)+p[1][7]*pow(-159E-5,2));
  signal_a0w_m156->SetBinContent(8,1+p[0][7]*(-156E-5)+p[1][7]*pow(-156E-5,2));
  signal_a0w_m153->SetBinContent(8,1+p[0][7]*(-153E-5)+p[1][7]*pow(-153E-5,2));
  signal_a0w_m150->SetBinContent(8,1+p[0][7]*(-150E-5)+p[1][7]*pow(-150E-5,2));
  signal_a0w_m168->SetBinContent(8,1+p[0][7]*(-168E-5)+p[1][7]*pow(-168E-5,2));
  signal_a0w_m171->SetBinContent(8,1+p[0][7]*(-171E-5)+p[1][7]*pow(-171E-5,2));
  signal_a0w_m174->SetBinContent(8,1+p[0][7]*(-174E-5)+p[1][7]*pow(-174E-5,2));
  signal_a0w_m177->SetBinContent(8,1+p[0][7]*(-177E-5)+p[1][7]*pow(-177E-5,2));

  signal_a0w_140->SetBinContent(8,1+p[0][7]*(140E-5)+p[1][7]*pow(140E-5,2));
  signal_a0w_100->SetBinContent(8,1+p[0][7]*(100E-5)+p[1][7]*pow(100E-5,2));
  signal_a0w_80->SetBinContent(8,1+p[0][7]*(80E-5)+p[1][7]*pow(80E-5,2));

  signal_a0w_165->SetBinContent(8,1+p[0][7]*(165E-5)+p[1][7]*pow(165E-5,2));
  signal_a0w_162->SetBinContent(8,1+p[0][7]*(162E-5)+p[1][7]*pow(162E-5,2));
  signal_a0w_159->SetBinContent(8,1+p[0][7]*(159E-5)+p[1][7]*pow(159E-5,2));
  signal_a0w_156->SetBinContent(8,1+p[0][7]*(156E-5)+p[1][7]*pow(156E-5,2));
  signal_a0w_153->SetBinContent(8,1+p[0][7]*(153E-5)+p[1][7]*pow(153E-5,2));
  signal_a0w_150->SetBinContent(8,1+p[0][7]*(150E-5)+p[1][7]*pow(150E-5,2));
  signal_a0w_168->SetBinContent(8,1+p[0][7]*(168E-5)+p[1][7]*pow(168E-5,2));
  signal_a0w_171->SetBinContent(8,1+p[0][7]*(171E-5)+p[1][7]*pow(171E-5,2));
  signal_a0w_174->SetBinContent(8,1+p[0][7]*(174E-5)+p[1][7]*pow(174E-5,2));
  signal_a0w_177->SetBinContent(8,1+p[0][7]*(177E-5)+p[1][7]*pow(177E-5,2));
*/
