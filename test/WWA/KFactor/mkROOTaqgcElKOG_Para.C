...
Channel: WW+gamma semileptonic Electron channel (W -> ev, W -> jj, gamma)
...
void mkROOTaqgcElKOG_Para(){
  ...
  const double KOG_m5m5_scale     = 0.0470065 * intLUMI/194029;
  const double KOG_m2m5_scale     = 0.0249555 * intLUMI/195494;
  const double KOG_m3m5_scale     = 0.0302425 * intLUMI/196004;
  const double KOG_p5m5_scale     = 0.046106 * intLUMI/184331;
  const double KOG_p2m5_scale     = 0.0245765 * intLUMI/197493;
  const double KOG_p3m5_scale     = 0.029646 * intLUMI/139920;
...
//mva2jWWAelA1>0.2
  ...
  //////////////////////////////////////////////////
  // Specify K-factor function for each aQGC sample:
  TCut KFact_m5(TString(the_cutKfac)+TString("*((Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]<59.17)? 0.0049913*Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]+(2.1052-0.0049913*59.17) : (2.1052-1.185)*exp(-1*0.0099925*(Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]-59.17))+1.185)"));
  TCut KFact_m3(TString(the_cutKfac)+TString("*((Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]<59.166)? 0.0049973*Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]+(2.1703-0.0049973*59.166) : (2.1703-1.185)*exp(-1*0.0086936*(Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]-59.166))+1.185)"));
  TCut KFact_m2(TString(the_cutKfac)+TString("*((Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]<78.839)? 0.0049959*Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]+(2.1865-0.0049959*78.839) : (2.1865-1.185)*exp(-1*0.0086185*(Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]-78.839))+1.185)"));
  TCut KFact_2(TString(the_cutKfac)+TString("*((Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]<78.839)? 0.0049959*Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]+(2.1865-0.0049959*78.839) : (2.1865-1.185)*exp(-1*0.0086185*(Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]-78.839))+1.185)"));
  TCut KFact_3(TString(the_cutKfac)+TString("*((Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]<59.166)? 0.0049992*Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]+(2.2294-0.0049992*59.166) : (2.2294-1.185)*exp(-1*0.0088703*(Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]-59.166))+1.185)"));
  TCut KFact_5(TString(the_cutKfac)+TString("*((Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]<59.165)? 0.0049744*Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]+(2.1019-0.0049744*59.165) : (2.1019-1.185)*exp(-1*0.0099992*(Photon_Et[(iPhoton12>-1)? iPhoton12 : 0]-59.165))+1.185)"));


  ///////////////////////////
  // Create output ROOT file:
  TFile f("para_el_a0W_WWA_PhotonEt.root", "RECREATE");
  ...
  KOG_m5m5_file = new TFile("InData_New/RD_el_KOG_m5m5MG_CMSSW532.root");
  KOG_m3m5_file = new TFile("InData_New/RD_el_KOG_m3m5MG_CMSSW532.root");
  KOG_m2m5_file = new TFile("InData_New/RD_el_KOG_m2m5MG_CMSSW532.root");
  KOG_p2m5_file = new TFile("InData_New/RD_el_KOG_p2m5MG_CMSSW532.root");
  KOG_p3m5_file = new TFile("InData_New/RD_el_KOG_p3m5MG_CMSSW532.root");
  KOG_p5m5_file = new TFile("InData_New/RD_el_KOG_p5m5MG_CMSSW532.root");
  ...
  treeKOG_p5m5->Draw(TString(pv.plotvar)+TString(">>signal_a0w_m50"), KFact_m5, "goff");

  std::cout<<"Fill aQGC_2 WWA Histogram..."<<std::endl;
  treeKOG_p3m5->Draw(TString(pv.plotvar)+TString(">>signal_a0w_m30"), KFact_m3, "goff");
  
  std::cout<<"Fill aQGC_3 WWA Histogram..."<<std::endl;
  treeKOG_p2m5->Draw(TString(pv.plotvar)+TString(">>signal_a0w_m20"), KFact_m2, "goff");

  std::cout<<"Fill aQGC_4 WWA Histogram..."<<std::endl;
  treeKOG_m2m5->Draw(TString(pv.plotvar)+TString(">>signal_a0w_20"), KFact_2, "goff");
  
  std::cout<<"Fill aQGC_5 WWA Histogram..."<<std::endl;
  treeKOG_m3m5->Draw(TString(pv.plotvar)+TString(">>signal_a0w_30"), KFact_3, "goff");
  
  std::cout<<"Fill aQGC_6 WWA Histogram..."<<std::endl;
  treeKOG_m5m5->Draw(TString(pv.plotvar)+TString(">>signal_a0w_50"), KFact_5, "goff");
...
//  test->SetBinContent(8,1+p[0][7]*(5E-5)+p[1][7]*pow(5E-5,2));
//  test2->SetBinContent(8,1+p[0][7]*(-5E-5)+p[1][7]*pow(-5E-5,2));
...
/*
  signal_a0w_m50->SetBinContent(8,1+p[0][7]*(-5.E-5)+p[1][7]*pow(-5.E-5,2));
  signal_a0w_m30->SetBinContent(8,1+p[0][7]*(-3.E-5)+p[1][7]*pow(-3.E-5,2));
  signal_a0w_m20->SetBinContent(8,1+p[0][7]*(-2.E-5)+p[1][7]*pow(-2.E-5,2));

  signal_a0w_m28->SetBinContent(8,1+p[0][7]*(-2.8E-5)+p[1][7]*pow(-2.8E-5,2));
  signal_a0w_m26->SetBinContent(8,1+p[0][7]*(-2.6E-5)+p[1][7]*pow(-2.6E-5,2));
  signal_a0w_m24->SetBinContent(8,1+p[0][7]*(-2.4E-5)+p[1][7]*pow(-2.4E-5,2));
  signal_a0w_m22->SetBinContent(8,1+p[0][7]*(-2.2E-5)+p[1][7]*pow(-2.2E-5,2));
  signal_a0w_m18->SetBinContent(8,1+p[0][7]*(-1.8E-5)+p[1][7]*pow(-1.8E-5,2));
  signal_a0w_m16->SetBinContent(8,1+p[0][7]*(-1.6E-5)+p[1][7]*pow(-1.6E-5,2));
  signal_a0w_m32->SetBinContent(8,1+p[0][7]*(-3.2E-5)+p[1][7]*pow(-3.2E-5,2));
  signal_a0w_m34->SetBinContent(8,1+p[0][7]*(-3.4E-5)+p[1][7]*pow(-3.4E-5,2));
  signal_a0w_m36->SetBinContent(8,1+p[0][7]*(-3.6E-5)+p[1][7]*pow(-3.6E-5,2));
  signal_a0w_m38->SetBinContent(8,1+p[0][7]*(-3.8E-5)+p[1][7]*pow(-3.8E-5,2));

  signal_a0w_50->SetBinContent(8,1+p[0][7]*(5.E-5)+p[1][7]*pow(5.E-5,2));
  signal_a0w_30->SetBinContent(8,1+p[0][7]*(3.E-5)+p[1][7]*pow(3.E-5,2));
  signal_a0w_20->SetBinContent(8,1+p[0][7]*(2.E-5)+p[1][7]*pow(2.E-5,2));

  signal_a0w_28->SetBinContent(8,1+p[0][7]*(2.8E-5)+p[1][7]*pow(2.8E-5,2));
  signal_a0w_26->SetBinContent(8,1+p[0][7]*(2.6E-5)+p[1][7]*pow(2.6E-5,2));
  signal_a0w_24->SetBinContent(8,1+p[0][7]*(2.4E-5)+p[1][7]*pow(2.4E-5,2));
  signal_a0w_22->SetBinContent(8,1+p[0][7]*(2.2E-5)+p[1][7]*pow(2.2E-5,2));
  signal_a0w_18->SetBinContent(8,1+p[0][7]*(1.8E-5)+p[1][7]*pow(1.8E-5,2));
  signal_a0w_16->SetBinContent(8,1+p[0][7]*(1.6E-5)+p[1][7]*pow(1.6E-5,2));
  signal_a0w_32->SetBinContent(8,1+p[0][7]*(3.2E-5)+p[1][7]*pow(3.2E-5,2));
  signal_a0w_34->SetBinContent(8,1+p[0][7]*(3.4E-5)+p[1][7]*pow(3.4E-5,2));
  signal_a0w_36->SetBinContent(8,1+p[0][7]*(3.6E-5)+p[1][7]*pow(3.6E-5,2));
  signal_a0w_38->SetBinContent(8,1+p[0][7]*(3.8E-5)+p[1][7]*pow(3.8E-5,2));
*/
