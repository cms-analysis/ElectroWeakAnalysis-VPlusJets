...
const char* selection = "JetPFCor_Pt[1]/Mass2j_PFCor>0.3 && gdevtt && fit_status==0 && fit_chi2/fit_NDF<10. && JetPFCor_bDiscriminator[0]<1.74 && JetPFCor_bDiscriminator[1]<1.74 && cosJacksonAngle2j_PFCor<0.8 && cosJacksonAngle2j_PFCor>-0.6";
