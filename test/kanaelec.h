...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uscms_data/d2/yangf/ana/WuvWjj/DataFile/MergFile/WenuJets_DataAll_GoldenJSON_2p1invfb.root");
      if (!f) {
         f = new TFile("/uscms_data/d2/yangf/ana/WuvWjj/DataFile/MergFile/WenuJets_DataAll_GoldenJSON_2p1invfb.root");
      }
