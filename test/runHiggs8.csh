...
foreach flavor ( "Muons" "Electrons" )
	...
	echo "Higgs mass: $mH $flavor 2 jets"
	python runHWWFitter.py -b -m HWW"$flavor"Config -j 2 -H $mH -W -1 -s $syst >&! H"$mH"_"$flavor"_2jets_FitterOutput.out
    end
    ...
    foreach mH ( 180 190 200 )
	echo "Higgs mass: $mH $flavor 3 jets"
	python runHWWFitter.py -b -m HWW"$flavor"Config -j 3 -H $mH -W -1 -s $syst >&! H"$mH"_"$flavor"_3jets_FitterOutput.out
    end

    foreach mH ( 250 300 )
    	echo "Higgs mass: $mH $flavor 3 jets"
    	python runHWWFitter.py -b -m HWW"$flavor"Config -j 3 -H $mH -W 5 -s $syst >&! H"$mH"_"$flavor"_3jets_FitterOutput.out
    end
end
