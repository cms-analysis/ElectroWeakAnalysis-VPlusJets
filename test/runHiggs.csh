...
foreach mH ( 170 180 190 200 )
    echo "Higgs mass: $mH muons 3 jets"
    python runHWWFitter.py -b -m HWWMuonsConfig -j 3 -H $mH -W 4 >&! H"$mH"_Muon_3jets_FitterOutput.out
end
...
foreach mH ( 170 180 190 200 )
    echo "Higgs mass: $mH electrons 3 jets"
    python runHWWFitter.py -b -m HWWElectronsConfig -j 3 -H $mH -W 4 >&! H"$mH"_Electron_3jets_FitterOutput.out
end
